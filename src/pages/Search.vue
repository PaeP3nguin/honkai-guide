...
const bossToChinese = {
  ...
  "Husk: Existentialism": ["虚花", "虚树摊骸-存在主义"],
  "Jizo Mitama": ["地藏", "地藏御魂"],
  Kallen: ["卡莲"],
  Kalpas: ["千劫", "杰哥", "劫哥", "千师傅"],
  Kasumi: ["八重霞"],
...
const valkToChinese = {
  ...
  "Herrscher of Finality (HoFi)": ["终"],
  "Herrscher of Human Ego (HoH, HoHE, HoE)": ["人", "爱猫兔", "爱律"],
  "Herrscher of Origin (HoO)": ["始"],
  ...
  "Jade Knight (Li Sushang, JK)": ["李", "李素裳", "玉骑士月痕"],
  ...
  "Pledge (VP)": ["誓"],
  "Ranger (VR)": ["游"],
  "Reverist Calico (RC, Cat, Neko, Pardofelis)": ["猫"],
  "Rondo (SR)": ["樱"],
  "Scarlet Fusion (SF)": ["深"],
  ...
  "Herrscher Trio (Herrscher of Finality, Herrscher of Origin, Herrscher of Truth)": ["虚三家"],
  ...
  "Deepspace Anchor First Light (DAFL, Senadina)": ["希娜", "希娜迪雅"],
  "Senadina Trio (Deepspace Anchor First Light, Valkyrie Boltstorm, Valkyrie Blastmetal, Senadina, Helia, Coralie)": ["星三家"],
  <!-- ELFs & Collaborators -->
