  ...
  <v-container>
    <v-layout>
      <v-flex xs12 md10>
        ...
        <ul>
          <li>2024/06/21 - Added Songque, Serapeum, and Meteoroid Fusion: Epernay. I wonder if they will ever fix the incorrect spelling in game: "Meteroid"? - Darius</li>
...
const valkToChinese = {
  ...
  "Disciplinary Perdition (DP, Aponia)": ["阿", "阿波尼亚"],
